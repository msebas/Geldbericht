...
/**
 * A partial clone of {@link javafx.scene.control.cell.CellUtils}, because 
 * it is package protected causing problems to implement classes similar to
 * {@link TextFieldTableCell} for some special cases and especially fine 
 * tuning the behavior.  
 * 
 * @since JavaFX 2.2
 */
